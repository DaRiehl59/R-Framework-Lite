...
CREATE TABLE `affecter` (
  ...
  CONSTRAINT `affecter_ibfk_1` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateur` (`id`),
  CONSTRAINT `affecter_ibfk_2` FOREIGN KEY (`id_groupe`) REFERENCES `groupe` (`id`)
...
INSERT INTO `affecter` VALUES (1,1),(2,2),(2,3),(2,4),(2,5),(2,6),(2,7),(2,9);
...
CREATE TABLE `attribuer` (
  ...
  KEY `id_groupe` (`id_groupe`),
  CONSTRAINT `attribuer_ibfk_1` FOREIGN KEY (`id_groupe`) REFERENCES `groupe` (`id`),
  CONSTRAINT `attribuer_ibfk_2` FOREIGN KEY (`id_droit`) REFERENCES `droit` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `confidentialite`
--

LOCK TABLES `confidentialite` WRITE;
/*!40000 ALTER TABLE `confidentialite` DISABLE KEYS */;
INSERT INTO `confidentialite` VALUES (1,'tout le monde'),(2,'les contacts de mes contacts'),(3,'mes contacts'),(4,'seulement moi');
/*!40000 ALTER TABLE `confidentialite` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `droit` VALUES (1,'UtilisateurControler::connect',1),(3,'UtilisateurControler::create',1),(4,'UtilisateurControler::forgotten',1),(5,'UtilisateurControler::disconnect',1),(6,'UtilisateurControler::invite',1),(7,'UtilisateurControler::read_profil',1),(8,'UtilisateurControler::update_owner_profil',1),(9,'UtilisateurControler::upload_avatar',1),(10,'UtilisateurControler::select_avatar',1),(11,'UtilisateurControler::update_confid',1),(12,'UtilisateurControler::read_list',1),(13,'UtilisateurControler::read_profil',1),(14,'UtilisateurControler::add_contact',1),(15,'UtilisateurControler::remove_contact',1),(16,'UtilisateurControler::block_contact',1),(17,'UtilisateurSignalControler::create',1),(18,'MessageControler::create',1),(19,'MessageControler::read_owner',1),(20,'MessageControler::archive_owner',1),(21,'MessageSignalControler::create',1),(22,'PersonnageControler::create',1),(23,'PersonnageControler::update_owner',1),(24,'PersonnageControler::archive_owner',1),(25,'InterventionControler::create',1),(26,'InterventionControler::use_action',1),(27,'InterventionControler::update_owner',1),(28,'InterventionSignalControler::create',1),(29,'MessageRPControler::create',1),(30,'MessageRPControler::read_owner',1),(31,'MessageRPControler::archive_owner',1),(32,'MessageRPSignalControler::create',1),(33,'AventureControler::create',1),(34,'AventureControler::update_owner',1),(35,'AventureControler::archive_owner',1),(36,'AventureControler::close_owner',1);
...
INSERT INTO `groupe` VALUES (1,'Grand Concepteur','Maître absolu et incontesté des Univers.',1,'2c7fa0fa37eb7dc32a772f20c5306ac277b08768.png',1,1),(2,'Architecte(s)','Maître d&#39;un Univers.',1,'0c9a7e3da93a997931c324f3b7c554d2c477f71b.png',1,1),(3,'Maître(s) de Jeu','Assistant de l&#39;architecte sur le développement RP de son Univers.',1,'3159333ba60204a296f1367ea4059c59da45ee7b.png',1,1),(4,'Juge(s)','Impartial, il fait appliquer la loi dans un secteur.\r\nUne fois rendue, sa décision ne peut être contestée.',1,'f05e649c978352cd60a1bfcdb3a269a48798295a.png',1,1),(5,'Bourreau(x)','Mystérieux et solitaire, il applique les sentences prononcées par le juge.',3,'4996de5c03d390882127c9d26fde43284f4f1294.png',1,1),(6,'Diplomate(s)','Généreux et volontaire, il est le garant de la paix dans un secteur.\r\nIl s&#39;assure que les conflits peuvent être réglés à l&#39;amiable avant de les porter devant le tribunal.\r\n',5,'31c56cea6c961b45036a6f8007b5ba8591e5acf7.png',1,1),(7,'Veilleur(s)','Attentif, discret, honnête, il surveille le déroulement des aventures\r\net le comportement RP / HRP des personnages / utilisateurs.\r\nEn cas d&#39;infraction aux règlements du site, du secteur, ou de l&#39;univers\r\nle veilleur fait un signalement objectif et précis de l&#39;incident.',10,'dad5e7cde0cb21564176ed18ced68aec41c88719.png',1,1),(8,'Scribe(s)','Irréprochable dans son orthographe, et sa grammaire, il est le garant du respect de la langue Française.',20,'5f8b9b655d9d5b32f97d6d03dd6bcc5970823b1e.png',1,1),(9,'Utilisateur(s)','Utilisateur normal',0,NULL,1,1),(10,'Anonyme(s)','Internaute non connecté',0,NULL,0,1);
...
CREATE TABLE `utilisateur` (
  ...
  CONSTRAINT `utilisateur_ibfk_1` FOREIGN KEY (`id_confid_nom`) REFERENCES `confidentialite` (`id`),
  CONSTRAINT `utilisateur_ibfk_2` FOREIGN KEY (`id_confid_email`) REFERENCES `confidentialite` (`id`),
  CONSTRAINT `utilisateur_ibfk_3` FOREIGN KEY (`id_confid_ville`) REFERENCES `confidentialite` (`id`),
  CONSTRAINT `utilisateur_ibfk_4` FOREIGN KEY (`id_pays`) REFERENCES `pays` (`id`),
  CONSTRAINT `utilisateur_ibfk_5` FOREIGN KEY (`id_confid_pays`) REFERENCES `confidentialite` (`id`),
  CONSTRAINT `utilisateur_ibfk_6` FOREIGN KEY (`id_confid_description`) REFERENCES `confidentialite` (`id`)
...
INSERT INTO `utilisateur` VALUES (1,'root','','Maître',NULL,'Administrateur',1,'',1,NULL,1,NULL,1,'',1),(2,'david.riehl','david','D.A.R.Y.L.',NULL,'David RIEHL',4,'david.riehl@ac-lille.fr',3,'Valenciennes',2,75,1,'',1);
...
-- Dump completed on 2015-11-06  8:55:31
