<?php
/**
 * Classe d'accès à la table `niveau_utilisateur`
 *
 * @filesource model/table/Niveau_UtilisateurTable.php
...
class Niveau_UtilisateurTable {
     ...
     * @access private
     */
    private static $table = "niveau_utilisateur";
